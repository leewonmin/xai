...
model_id = "stan-hua/Mistral-Small-Instruct-2409-GPTQ-4bit" #22B
...
def build_company_single_prompt(company_row, rec_row):
    ...
    #키워드 유사도 70이상인 값만 사용 
    #sim_keyword = rec_row.get("keyword_links", []) 
...
out_path = '/content/drive/MyDrive/Colab Notebooks/kisti/result/mistral_GPTQ.csv'
